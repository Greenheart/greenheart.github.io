    ...
    <section>
        ...
        <div className={styles.topic}>
            ...
            <p>
                ...
                comfortable with other tech stacks. It all depends on what's a
        ...
        <div className={styles.topic}>
            ...
            <p>
                Open source enthusiast who enjoys sharing what I learn and help
                others. Former core team member of the education non-profit{' '}
        ...
        <div className={styles.topic}>
            ...
            <p>
                Orienteering - fun exercise while exploring new terrain. I guess
                there couldn't be a better hobby as a developer, always
                exploring new code.
            </p>
        </div>
