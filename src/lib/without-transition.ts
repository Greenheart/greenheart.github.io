...
// Adapted from https://github.com/svecosystem/mode-watcher/blob/1eb14b4c519d179728dcf1c7352d97fad6f168b9/packages/mode-watcher/src/lib/without-transition.ts
...
export function withoutTransition(action: () => any, synchronous = false) {
    ...
    const isTest =
        ...
        (typeof window !== 'undefined' &&
            (window as unknown as { __vitest_worker__?: boolean })
                .__vitest_worker__)
