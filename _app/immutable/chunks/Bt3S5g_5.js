...
<span class="token keyword">export</span> <span class="token keyword">default</span> crypto</code>`),s(t);var o=a(t,8),_=n(o);e(_,()=>`<code class="language-js"><span class="token comment">// generate-password.js</span>
...
<span class="token keyword">const</span> <span class="token constant">CHAR_SET</span> <span class="token operator">=</span> digits <span class="token operator">+</span> upper <span class="token operator">+</span> lower</code>`),s(o);var p=a(o,4),C=n(p);e(C,()=>`<code class="language-js"><span class="token comment">/**
...
<span class="token punctuation">&#125;</span></code>`),s(p);var r=a(p,6),T=n(r);e(T,()=>`<code class="language-js">
<span class="token comment">/**
...
<span class="token punctuation">&#125;</span></code>`),s(r);var c=a(r,8),j=n(c);e(j,()=>`<code class="language-js"><span class="token keyword">const</span> characters <span class="token operator">=</span> <span class="token string">'...'</span>
...
<span class="token keyword">const</span> second <span class="token operator">=</span> characters<span class="token punctuation">[</span>index2<span class="token punctuation">]</span> <span class="token comment">// Returns the first character!</span></code>`),s(c);var l=a(c,8),R=n(l);e(R,()=>'<code class="language-js"><span class="token keyword">const</span> max <span class="token operator">=</span> <span class="token number">256</span> <span class="token operator">-</span> <span class="token punctuation">(</span><span class="token number">256</span> <span class="token operator">%</span> characters<span class="token punctuation">.</span>length<span class="token punctuation">)</span></code>'),s(l);var u=a(l,4),A=n(u);e(A,()=>'<code class="language-js"><span class="token keyword">const</span> max <span class="token operator">=</span> <span class="token number">256</span> <span class="token operator">-</span> <span class="token punctuation">(</span><span class="token number">256</span> <span class="token operator">%</span> <span class="token number">60</span><span class="token punctuation">)</span> <span class="token comment">// 240</span></code>'),s(u);var i=a(u,4),N=n(i);e(N,()=>`<code class="language-js"><span class="token comment">/**
 * Get a random character from a given set of characters.
 *
 * @param &#123;string&#125; characters The set of characters to pick from.
 * @returns A random character.
...
<span class="token keyword">function</span> <span class="token function">getRandomCharacter</span><span class="token punctuation">(</span><span class="token parameter">characters</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token keyword">return</span> characters<span class="token punctuation">[</span>randomNumber <span class="token operator">%</span> characters<span class="token punctuation">.</span>length<span class="token punctuation">]</span>
<span class="token punctuation">&#125;</span></code>`),s(i);var k=a(i,6),x=n(k);e(x,()=>`<code class="language-js"><span class="token comment">// generate-password.js</span>
...
<span class="token keyword">function</span> <span class="token function">getRandomCharacter</span><span class="token punctuation">(</span><span class="token parameter">characters</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token keyword">return</span> characters<span class="token punctuation">[</span>randomNumber <span class="token operator">%</span> characters<span class="token punctuation">.</span>length<span class="token punctuation">]</span>
<span class="token punctuation">&#125;</span></code>`),s(k);var d=a(k,8),S=n(d);e(S,()=>'<code class="language-shell"><span class="token function">npm</span> i pagecrypt</code>'),s(d);var m=a(d,4),P=n(m);e(P,()=>`<code class="language-js"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> generatePassword <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'pagecrypt/core'</span>

<span class="token keyword">const</span> password <span class="token operator">=</span> <span class="token function">generatePassword</span><span class="token punctuation">(</span><span class="token number">64</span><span class="token punctuation">)</span></code>`),s(m),U(4),I(b,h)},$$slots:{default:!0}}))}export{Z as default,g as metadata};
