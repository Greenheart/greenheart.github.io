import{t as l,a as r}from"./T8C3Fs0j.js";import"./Cwhq-lES.js";import{s as i,f as u,c as k,r as f}from"./JBV3_3TY.js";import{h as d}from"./1PMyMUzQ.js";import{l as m,s as h}from"./DRFXFebB.js";import{B as g}from"./BIGiZ7_J.js";const a={title:"Rename File Extensions with Node.js",date:"2021-07-27T00:00:00.000Z",tags:["Code Snippet","JavaScript","Node.js"]},{title:F,date:j,tags:R}=a;var y=l('<p>A Node.js script to rename the file extension for all matching files in a directory.</p> <pre class="language-js"><!></pre>',1);function D(t,p){const e=m(p,["children","$$slots","$$events","$$legacy"]);g(t,h(()=>e,a,{children:(o,w)=>{var n=y(),s=i(u(n),2),c=k(s);d(c,()=>`<code class="language-js"><span class="token hashbang comment">#!/usr/bin/env node</span>
...
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>renamedCount<span class="token punctuation">)</span></code>`),f(s),r(o,n)},$$slots:{default:!0}}))}export{D as default,a as metadata};
