import{S as g,i as y,s as x,P as u,x as w,y as b,z as E,R as v,a4 as i,f as j,t as $,A as F,T as k,k as f,q as R,a as P,l as m,m as d,r as T,h as l,c as C,n as D,b as r,E as N,C as S}from"./index-a38481fa.js";import{P as A}from"./_post-cf9ad1dd.js";function q(c){let n,e,p,t,a=`<code class="language-js"><span class="token hashbang comment">#!/usr/bin/env node</span>
...
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>renamedCount<span class="token punctuation">)</span></code>`;return{c(){n=f("p"),e=R("A Node.js script to rename the file extension for all matching files in a directory."),p=P(),t=f("pre"),this.h()},l(s){n=m(s,"P",{});var o=d(n);e=T(o,"A Node.js script to rename the file extension for all matching files in a directory."),o.forEach(l),p=C(s),t=m(s,"PRE",{class:!0});var _=d(t);_.forEach(l),this.h()},h(){D(t,"class","language-js")},m(s,o){r(s,n,o),N(n,e),r(s,p,o),r(s,t,o),t.innerHTML=a},p:S,d(s){s&&l(n),s&&l(p),s&&l(t)}}}function z(c){let n,e;const p=[c[0],h];let t={$$slots:{default:[q]},$$scope:{ctx:c}};for(let a=0;a<p.length;a+=1)t=u(t,p[a]);return n=new A({props:t}),{c(){w(n.$$.fragment)},l(a){b(n.$$.fragment,a)},m(a,s){E(n,a,s),e=!0},p(a,[s]){const o=s&1?v(p,[s&1&&i(a[0]),s&0&&i(h)]):{};s&2&&(o.$$scope={dirty:s,ctx:a}),n.$set(o)},i(a){e||(j(n.$$.fragment,a),e=!0)},o(a){$(n.$$.fragment,a),e=!1},d(a){F(n,a)}}}const h={title:"Rename File Extensions with Node.js",date:"2021-07-27T00:00:00.000Z",tags:["Code Snippet","JavaScript","Node.js"]};function H(c,n,e){return c.$$set=p=>{e(0,n=u(u({},n),k(p)))},n=k(n),[n]}class L extends g{constructor(n){super(),y(this,n,H,z,x,{})}}export{L as default,h as metadata};
