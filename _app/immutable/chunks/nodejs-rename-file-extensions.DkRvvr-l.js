import{a as c,t as l}from"./disclose-version.1Vpr6LmH.js";import{s as r,f as i,c as u,r as k}from"./runtime.Cp43ptvP.js";import{h as f}from"./html.DPlMD9TO.js";import{l as d,s as m}from"./index-client.XEQ49Y8H.js";import{B as h}from"./BlogLayoutWrapper.VAtOGgHk.js";const g={title:"Rename File Extensions with Node.js",date:"2021-07-27T00:00:00.000Z",tags:["Code Snippet","JavaScript","Node.js"]};var y=l('<p>A Node.js script to rename the file extension for all matching files in a directory.</p> <pre class="language-js"><!></pre>',1);function _(a,t){const p=d(t,["children","$$slots","$$events","$$legacy"]);h(a,m(()=>p,g,{children:(e,w)=>{var n=y(),s=r(i(n),2),o=u(s);f(o,()=>`<code class="language-js"><span class="token hashbang comment">#!/usr/bin/env node</span>
...
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>renamedCount<span class="token punctuation">)</span></code>`),k(s),c(e,n)},$$slots:{default:!0}}))}export{_ as default,g as metadata};
